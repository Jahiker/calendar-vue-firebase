        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent">
              ...
              <v-text-field type="text" label="Agregar Detalles" v-model="details"></v-text-field>
        ...
        >
          ...
          >
            ...
            >
              ...
              <v-spacer></v-spacer>
              <v-btn icon v-if="currentlyEditing !== selectedEvent.id" @click.prevent="editEvent(selectedEvent.id)" class="mx-4">
                <v-icon>mdi-pencil</v-icon>
              </v-btn>
              <v-btn icon v-else @click.prevent="updateEvent(selectedEvent)" class="mx-4">
